//! Configuration loading and management for RustDrop.
//!
...
impl Config {
    ...
    /// Resolve the download directory, using platform default if not configured.
    ...
    pub fn config_dir() -> PathBuf {
        dirs::config_dir()
            .map(|d| d.join("rustdrop"))
            .unwrap_or_else(|| PathBuf::from(".rustdrop"))
    }
...
fn hostname() -> String {
    std::env::var("HOSTNAME")
        ...
        .unwrap_or_else(|_| "RustDrop Device".into())
}
