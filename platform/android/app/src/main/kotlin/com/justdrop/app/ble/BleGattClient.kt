...
class BleGattClient(private val context: Context) {
    ...
    interface Listener {
        fun onHandshakeComplete(deviceAddress: String, responseData: ByteArray)
        ...
        override fun onServicesDiscovered(gatt: BluetoothGatt, status: Int) {
            ...
            if (responseChar != null) {
                try {
                    ...
                    val descriptor = responseChar.getDescriptor(
    ...
    fun performHandshake(device: BluetoothDevice, data: ByteArray, listener: Listener) {
