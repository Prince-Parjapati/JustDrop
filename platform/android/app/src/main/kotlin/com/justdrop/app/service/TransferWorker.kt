...
class TransferWorker(
    ...
    companion object {
         ...
         */
        fun enqueue(context: Context, peerId: String, filePaths: List<String>): String {
    ...
    override suspend fun doWork(): Result {
        ...
        return try {
            ...
            val result = com.justdrop.app.JustBridge.sendFiles(peerId, pathsJson)
    ...
    private fun createForegroundInfo(transferId: String): ForegroundInfo {
        val notification = androidx.core.app.NotificationCompat.Builder(
            applicationContext, "justdrop_transfer"
        )
